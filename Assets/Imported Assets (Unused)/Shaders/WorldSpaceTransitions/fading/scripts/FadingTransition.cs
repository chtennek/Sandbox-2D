...
namespace WorldSpaceTransitions
{
    ...
    public class FadingTransition : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (!useDynamicTexture) Shader.SetGlobalTexture("_Curves", transitionTexture);
        ...
        void OnValidate()
        {
            ...
            Shader.SetGlobalTexture("_Curves", (useDynamicTexture ? DynamicCurveTexture.texture : transitionTexture));
